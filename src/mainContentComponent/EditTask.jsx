...
function EditTask(props){
    ...
    return (
        ...
        <Form.Group as={Row} controlId="t_name" className="mt-2">
            ...
            <Col sm={9}>
                <Form.Control as='input' name="t_name" type="text" placeholder="task name" value={name} onChange={onChangeName} required/>
            </Col>
        </Form.Group>
        <Form.Group as={Row}  controlId="t_priority">
            ...
            <Col sm={9}>
            <Form.Control as="select" name="t_priority" defaultValue={selectedPriority} ref={priority => task.t_priority = priority} custom required>
        ...
        <Form.Group as={Row}  controlId="t_status">
            ...
            <Col sm={9}>
            <Form.Control as="select" name="t_status" defaultValue={selecedStatus} ref={status => task.t_status = status}  custom required>
                <option value="" >Select one--</option>
        ...
        <Form.Group as={Row}  controlId="t_caregory">
            ...
            <Col sm={9}>
                <Form.Control as="select" name="t_category" defaultValue={props.task.t_category} ref={list => task.t_category = list}  custom required>
                    <option value="" >Select one--</option>
        ...
        <Form.Group as={Row}  controlId="t_group">
            ...
            <Col sm={9}>
            <Form.Control as="select" name="t_group" custom defaultValue={props.task.t_group} ref={tag => task.t_group = tag} required>
                <option value="" >Select one--</option>
        ...
        <Form.Group as={Row}>
            ...
            <Button id="editBtn"variant="success"type="submit" className="float-right">save</Button>
            </Col>
        </Form.Group>
